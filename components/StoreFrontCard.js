...
const StoreCard = props => {
  ...
  return (
    // <Wrapper style={{ background: "#FAFAFA 0% 0% no-repeat padding-box", boxShadow: "1px 1px 3px #0000003d", margin: "5px", height: "150px" }}>
    <Wrapper style={{ background: "#FAFAFA 0% 0% no-repeat padding-box", margin: "5px", height: "150px" }}>
