      ...
      <Container>
        ...
        {isMobileState ? (
          <div className="flex flex-col md:flex-row">
            <div className="flex-auto lg:w-80 md:w-80 sm:w-96 productLeft">
              <div>
                <div>
                  <h2
                    id="product-title"
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-auto lg:w-32 md:w-16">
              <div>
                ...
                >
                  <p className="md:text-sm" style={{ marginBottom: "5px" }}>
              ...
              <div>
                <div>{/* <WishListBar product={productDetailsData} /> */}</div>
                <div>
                  {/* <WishListBar product={productDetailsData} /> */}
                  <AddToCart
                    calculatedPriceAndFoundDist={calculatedPriceAndFoundDist}
