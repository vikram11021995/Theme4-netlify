...
import CategoryChildList from "../../components/theme1/category-child-list/CategoryChildList";
...
import Drawer from "../../components/elements/Drawer/DrawerFacets";
...
const Category = ({
  ...
  return (
    <Wrapper>
      ...
      <ExternalContentFromCMS place="home" position="Top" />
      ...
      <Container>
        <div className="facets-and-category-items-wrapper flex-row block">
          <div className="facets-wrapper facets-wrapper1">{renderFacets()}</div>
        ...
        {/*</div>*/}
        {/*<FacetBreadcrumb />*/}
        {/* <button onClick={() => setAuthModal(!authModal)}>Siva</button> */}
        {/* <Modal
          renderAlways={true}
          open={authModal}
